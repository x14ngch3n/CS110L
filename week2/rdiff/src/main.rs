...
fn main() {
    ...
    let filelines1 = read_file_lines(filename1).expect("file does not exist.");
    let filelines2 = read_file_lines(filename2).expect("file does not exist.");
    let grid = lcs(&filelines1, &filelines2);
    print_diff(
        &grid,
        &filelines1,
        &filelines2,
